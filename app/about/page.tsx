    ...
    <div className="min-h-screen pt-28">
      <PageTransition className="max-w-4xl mx-auto px-4 py-12">
        ...
        <div className="space-y-8">
          <section className="bg-white/5 rounded-2xl border border-white/10 shadow-sm p-6 md:p-8">
          ...
          <section className="bg-white/5 rounded-2xl border border-white/10 shadow-sm p-6 md:p-8">
            ...
            <div className="mb-4">
              <h3 className="text-sm font-semibold text-white/60 uppercase tracking-wide mb-3">Core Competencies</h3>
            ...
            <div>
              <h3 className="text-sm font-semibold text-white/60 uppercase tracking-wide mb-3">Data & Tools</h3>
              <div className="grid grid-cols-2 md:grid-cols-3 gap-3">
                {[
                  ...
                  <div
                    key={skill}
                    className="px-4 py-2.5 rounded-xl bg-white/10 text-white/90 text-sm font-medium text-center"
                  >
                    {skill}
                  </div>
                ))}
            ...
            <div className="space-y-6">
              <div>
                <div className="flex items-center justify-between mb-1">
                  <h3 className="font-semibold text-white">Strategy & Data Analyst</h3>
                  <span className="text-sm text-white/60">Jun 2025 - Present</span>
                </div>
              ...
              <div className="border-t border-white/10 pt-6">
                <div className="flex items-center justify-between mb-1">
                  <h3 className="font-semibold text-white">Operations Manager</h3>
                  <span className="text-sm text-white/60">May 2024 - Jun 2025</span>
                </div>
          ...
          <section className="bg-white/5 rounded-2xl border border-white/10 shadow-sm p-6 md:p-8">
            ...
            <div>
              <div className="flex items-center justify-between mb-1">
                <h3 className="font-semibold text-white">BA — Economics & Philosophy</h3>
                <span className="text-sm text-white/60">2019 - 2024</span>
              </div>
          ...
          <section className="bg-white/5 rounded-2xl border border-white/10 shadow-sm p-6 md:p-8">
            <h2 className="text-2xl font-bold text-white mb-4">Volunteering</h2>
            <div className="space-y-6">
              <div>
                <div className="flex items-center justify-between mb-1">
                  <h3 className="font-semibold text-white">Big Brother Mentor</h3>
                  <span className="text-sm text-white/60">2025 - Present</span>
                </div>
              ...
              <div className="border-t border-white/10 pt-6">
                <div className="flex items-center justify-between mb-1">
                  <h3 className="font-semibold text-white">Co-Chair, Relay For Life</h3>
                  <span className="text-sm text-white/60">Sep 2021 - May 2022</span>
                </div>
